...
const roger = new Cat('Roger', 2, 'Orange')
roger.printCatName();
//////////////////////////// PROBLEM 9 ////////////////////////////
/*
...
const ronald = new Wizard('Ronald Weasly', 16, 'Eat slugs');
ronald.castSpell();
//////////////////////////// PROBLEM 10 ////////////////////////////
/*
...
//Code Here
const phone1 = new Phone('Apple', 'iPhone 7', 32, 'Space Grey', 699);
const phone2 = new Phone('Apple', 'iPhone 8', 64, 'White', 799);
const phone3 = new Phone('Samsung', 'Galaxy 7', 128, 'Black', 750);
/* 
...
class Vehicle {
  constructor(capacity, color, mileage) {
    this.vehicleCap = capacity;
    this.vehicleColor = color;
    this.vehicleMileage = mileage;
  }
  move(miles) {
    console.log(miles + this.vehicleMileage)
  }
}
// const myFirstVehicle = new Vehicle(5, 'Blue', 1200)
// myFirstVehicle.move(12);
/*
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(2, 'Red', 6000, 'Honda');
/*
...
class Boat extends Vehicle {
  ...
  checkSeaWorthiness() {
    if (this.isSeaWorthy === true) {
      console.log(`The ${this.vehicleColor} ${this.boatType} is seaworthy!`)
    } else {
...
//Code Here
const myFirstBoat = new Boat(6, 'White', 2000, 'White Pearl', 'speed boat');
/*
...
//Code Here 
myFirstBoat.performMaintainance();
